...
1. Choose a unique name. It will be used as prefix of name of all Azure resources. If the name is already used, the deployment will fail. Note that the name should follow naming restrictions of storage account (lowercase, alphanumeric etc).
